...
fn main() {
    ...
    let window_size = Size::Physical(PhysicalSize::new(2048, 2048));
    let surface = WindowBuilder::new().with_inner_size(window_size).build_vk_surface(&event_loop, instance.clone()).unwrap();
